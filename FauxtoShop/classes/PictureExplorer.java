...
//rg added
   private JPanel setUpSideMenu()
   {
      ...
      JButton button_mirrorLR = new JButton("Mirror Left");
      button_mirrorLR.addActionListener(new Listener_MirrorLR());
      sub_panel.add(button_mirrorLR);

      JButton button_mirrorRL = new JButton("Mirror Right");
      button_mirrorRL.addActionListener(new Listener_MirrorRL());
      sub_panel.add(button_mirrorRL);
   	
      JButton button_mirrorTB = new JButton("Mirror Top");
      button_mirrorTB.addActionListener(new Listener_MirrorTB());
      sub_panel.add(button_mirrorTB);

      JButton button_mirrorBT = new JButton("Mirror Bottom");
      button_mirrorBT.addActionListener(new Listener_MirrorBT());
      sub_panel.add(button_mirrorBT);
      ...
      JButton button_mirrorDiagOpp = new JButton("Mirror Diag Opp");
      button_mirrorDiagOpp.addActionListener(new Listener_MirrorDiagOpp());
      sub_panel.add(button_mirrorDiagOpp);

      JButton button_dither = new JButton("Dither");
      button_dither.addActionListener(new Listener_dither());
      sub_panel.add(button_dither);
...
*/
   ...
   */
   ...
   private class Listener_MirrorRL implements ActionListener
   {
      public void actionPerformed(ActionEvent e)
      {
         ((Picture)picture).mirrorVerticalRightToLeft();
         updatePicture();
      }
   }
   ...
   private class Listener_MirrorBT implements ActionListener
   {
      public void actionPerformed(ActionEvent e)
      {
         ((Picture)picture).mirrorHorizontalBotToTop();
         updatePicture();
      }
   }
   ...
   private class Listener_MirrorDiagOpp implements ActionListener
   {
      public void actionPerformed(ActionEvent e)
      {
   ...
   private class Listener_dither implements ActionListener
   {
      public void actionPerformed(ActionEvent e)
      {
   ...
   private class Listener_EdgeDetector implements ActionListener
   {
      public void actionPerformed(ActionEvent e)
      {
         ((Picture)picture).edgeDetection(35);
         updatePicture(); 
      }
   }
